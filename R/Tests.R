...
#'
#' A general version of the Mann-Kendall test, enabling various dependence assumptions.
#'
#' @param X numeric vector, data. IMPORTANT: X is assumed to be regularly-spaced.
#'          Use NA to fill the gaps rather than removing missing values.
